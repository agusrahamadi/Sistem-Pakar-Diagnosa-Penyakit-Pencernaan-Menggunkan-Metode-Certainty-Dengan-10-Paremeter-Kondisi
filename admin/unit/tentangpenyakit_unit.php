                              ...
                              <table id="datatable" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    while($ddatagrid=mysqli_fetch_assoc($rdatagrid)) {
										...
										if ($ddatagrid[gambar]) {
										$gambar = '../gambar/' . $ddatagrid[gambar];
										} else {
                                        ...
                                        <tr>
                                             ...
                                             <td style= text-align:left  >$ddatagrid[srn_tentangpenyakit]</td>
											 <td style= text-align:left  ><img  src='$gambar' width=100></td>
              ...
              <li>Data Master</li>
                  ...
                  <form class="form-horizontal" id="tambah_kat" name="tambah_kat" method="post" action="?unit=tentangpenyakit_unit&act=inputact" enctype="multipart/form-data" >    
                   ...
                   <textarea class="form-control limited" name="det_tentangpenyakit" id="det_tentangpenyakit"> </textarea>	
					   ...
					   <div class="form-group">
                   <label    for="srn_tentangpenyakit">Saran Penyakit :</label>	
                   <div >
                   <textarea class="form-control limited" name="srn_tentangpenyakit" id="srn_tentangpenyakit"> </textarea>	
                    </div>
                       </div>
                      ...
                      <div class="form-group">
					   ...
					   <div class="form-group">
                          <label for="gambar">Gambar :</label>
                            <div >
                                <input type="file" name="gambar" id="gambar" accept="image/*" />	
                             <img id='preview' src='<?php echo $gambar ?>' width=150>
